...
\section{Projects}
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed a full-stack web application using Django serving REST API and with React as the frontend}
            ...
            \resumeItem{Deployed the application on Digital Ocean, and configured a reverse proxy server using Nginx}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
